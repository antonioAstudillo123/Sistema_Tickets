<div wire:ignore id="editMantenimientoModal" class="modal" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Editar un mantenimiento</h5>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button wire:click="update" type="button" class="btn btn-primary">Actualizar mantenimiento</button>
        </div>
      </div>
    </div>
  </div>
